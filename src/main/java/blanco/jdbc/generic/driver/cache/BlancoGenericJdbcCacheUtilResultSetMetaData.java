...
public class BlancoGenericJdbcCacheUtilResultSetMetaData {
	public static void createCacheTableOfResultSetMetaData(final Connection connCache, final String globalUniqueKey)
			throws SQLException {
