...
public abstract class AbstractBlancoGenericJdbcStatement implements BlancoGenericJdbcBlockReadStatement {
	...
	public void addBatch(String sql) throws SQLException {
		throw new SQLFeatureNotSupportedException(
				BlancoGenericJdbcConstants.MESSAGE_NO_UPDATE_SUPPORTED + ": addBatch(String sql)");
	}

	public void clearBatch() throws SQLException {
		throw new SQLFeatureNotSupportedException(
				BlancoGenericJdbcConstants.MESSAGE_NO_UPDATE_SUPPORTED + ": clearBatch()");
	}

	public int[] executeBatch() throws SQLException {
		throw new SQLFeatureNotSupportedException(
				BlancoGenericJdbcConstants.MESSAGE_NO_UPDATE_SUPPORTED + ": executeBatch()");
	}
